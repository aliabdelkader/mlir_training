// RUN: mlir-training-opt --canonicalize %s | FileCheck %s
...
func.func @test_difference_of_squares(%0: !poly.poly<3>, %1: !poly.poly<3>) -> !poly.poly<3> {
    // CHECK: func.func @test_difference_of_squares(%[[x:.+]]: !poly.poly<3>, %[[y:.+]]: !poly.poly<3>)
...
func.func @test_difference_of_squares_other_uses(%0: !poly.poly<3>, %1: !poly.poly<3>) -> !poly.poly<3> {
    // CHECK: func.func @test_difference_of_squares_other_uses(%[[x:.+]]: !poly.poly<3>, %[[y:.+]]: !poly.poly<3>)
...
func.func @test_normalize_conj_through_eval(%f: !poly.poly<3>, %z: complex<f64>) -> complex<f64> {
